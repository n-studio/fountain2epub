// Based on Fountain.js by Matt Daly. https://github.com/mattdaly/Fountain.js
...
function tokenize(script) {
    let src = lexer(script).split(regex.splitter),
        i = src.length,
        line, match, parts, text, meta, x, xlen, dual,
        tokens = [];
...
function parse(script, toks, callback) {
...
module.exports = (script, tokens, callback) => {
